...
### 🔭 Current Focus
- 🛠️ **Working on**: [Chip 8 Emulator](https://github.com/alecmucz/Chip8Interpreter) — My first emulator project written in C++.
- 📚 **Exploring**: Advanced concepts in C++ programming and the inner workings of low-level applications.
- 🌱 **Goals**: 
  - Dive deeper into systems programming.  
  - Build my knowledge of operating systems, compilers, and networking.  
  - Eventually explore Rust for its unique approach to memory safety.  
...
<div style="display: flex; align-items: center; justify-content: center;">
  ...
  <img height="180px" src="https://github-readme-stats.vercel.app/api/top-langs/?username=alecmucz&layout=compact&langs_count=3" alt="Top Languages">
</div>
